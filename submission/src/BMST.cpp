	...
	bool Solver_EBP(ofstream& out_result){
		...
		try {
			...
			*/
			...
			out_result << lp_obj << "\t" << mip_obj << "\t" << gap << "\t" << float(std::chrono::duration_cast<std::chrono::milliseconds>(end - begin).count()) / 1000 << '\t';

			cout <<  lp_obj << "\t" << mip_obj << "\t" << gap << "\t" << float(std::chrono::duration_cast<std::chrono::milliseconds>(end - begin).count()) / 1000 << endl;
	...
	bool Solver_BP(ofstream& out_result){
		...
		try {
			...
			*/
			...
			out_result << num_nodes_ << "\t" << num_edges_ << "\t" << lp_obj << "\t" << mip_obj << "\t" << gap << "\t" << float(std::chrono::duration_cast<std::chrono::milliseconds>(end - begin).count()) / 1000 << '\t';

			cout << num_nodes_ << "\t" << num_edges_ <<  "\t" << lp_obj << "\t" << mip_obj << "\t" << gap << "\t" << float(std::chrono::duration_cast<std::chrono::milliseconds>(end - begin).count()) / 1000 << '\t';
